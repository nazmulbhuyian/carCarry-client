...
const UserAllRide = ({data}) => {
    return (
        <div className="border border-gray-300 bg-sky-50 mb-4 rounded-lg lg:p-4 lg:px-12 flex items-center justify-between hover:shadow-xl hover:scale-105">
