...
import DriverSelfBooking from "./DriverSelfBooking/DriverSelfBooking";
import DriverRequestBookings from "./DriverRequestBooking/DriverRequestBookings";


const DriverOverviewDetail = ({id}) => {
    ...
    return (
        <div className="">
            ...
            <div className="mt-4">
                {
                    value == 1 ?
                        <DriverSelfBooking></DriverSelfBooking>
                        :
                        <DriverRequestBookings id={id}></DriverRequestBookings>
                }
            </div>
        </div>
    );
...
export default DriverOverviewDetail;