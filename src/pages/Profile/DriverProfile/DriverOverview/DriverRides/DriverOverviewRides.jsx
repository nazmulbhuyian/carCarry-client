...
import DriverSelfBookings from "./DriverSelfBookings/DriverSelfBookings";
import DriverRequestBookings from "./DriverRequestBookings/DriverRequestBookings";


const DriverOverviewRides = () => {
    ...
    return (
        <div className="">
            ...
            <div className="mt-4">
                {
                    value == 1 ?
                        <DriverSelfBookings></DriverSelfBookings>
                        :
                        <DriverRequestBookings></DriverRequestBookings>
                }
            </div>
        </div>
    );
...
export default DriverOverviewRides;