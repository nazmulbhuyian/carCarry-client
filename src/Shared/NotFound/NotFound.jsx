...
const NotFound = () => {
    return (
        <article className='container mx-auto min-h-screen'>
            <h1 className='text-center text-4xl text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-primary font-semibold'>You're Out of Car Carry server</h1>
            <h1 className="glitch">
